...
typedef struct hiSVP_NNIE_ROIMEDIA_POOL_INFO_S {
...
typedef struct hiSVP_NNIE_MODEL_S {
    ...
    SVP_NNIE_ROIMEDIA_POOL_INFO_S astRoiInfo[SVP_NNIE_MAX_ROI_LAYER_NUM]; /* ROIPooling info */
