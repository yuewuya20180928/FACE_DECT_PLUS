...
void imx327_2l_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
    ...
    imx327_2l_write_register(ViPipe, 0x3007, 0x00); /* 0:HD1080p; 1-HD720p */
    imx327_2l_write_register(ViPipe, 0x3009, 0x02); /* 1-60fps; 2-30fps */
    imx327_2l_write_register(ViPipe, 0x300A, 0x3C); /* 10bit-0x3c; 12bit-0xF0 */

    //imx327_2l_write_register(ViPipe, 0x3011, 0x0A); /* Change after reset; */

    imx327_2l_write_register(ViPipe, 0x3012, 0x64);
    imx327_2l_write_register(ViPipe, 0x3013, 0x00);

    imx327_2l_write_register(ViPipe, 0x3018, 0x65); /* VMAX[7:0] */
    imx327_2l_write_register(ViPipe, 0x3019, 0x04); /* VMAX[15:8] */

    imx327_2l_write_register(ViPipe, 0x301c, 0x30); /* HMAX[7:0] */ /* the value of this register adjusting by fps */
    imx327_2l_write_register(ViPipe, 0x301d, 0x11); /* HMAX[15:8] */

    //imx327_2l_write_register(ViPipe, 0x3020, 0x02); /* Sets the shutter sweep time */
    //imx327_2l_write_register(ViPipe, 0x3021, 0x00);

    imx327_2l_write_register(ViPipe, 0x3046, 0x01); /* ODBIT output 10 bit */
    ...
    imx327_2l_write_register(ViPipe, 0x3128, 0x04);
    #endif

    imx327_2l_write_register(ViPipe, 0x3129, 0x00); /* ADBIT1,12Bit;0x1D->10Bit */
    //imx327_2l_write_register(ViPipe, 0x313b, 0x41);

    imx327_2l_write_register(ViPipe, 0x315e, 0x1a); /* 1A-37.125MHz; 1B->74.25MHz*/
    imx327_2l_write_register(ViPipe, 0x3164, 0x1a); /* 1A-37.125MHz; 1B->74.25MHz*/
    ...
    /*MIPI setting*/
    imx327_2l_write_register(ViPipe, 0x3405, 0x01);
    imx327_2l_write_register(ViPipe, 0x3407, 0x01);
    ...
    imx327_2l_write_register(ViPipe, 0x3443, 0x01); /* 2 lane */

    imx327_2l_write_register(ViPipe, 0x3444, 0x20); /* sensor clock */
    imx327_2l_write_register(ViPipe, 0x3445, 0x25);

    imx327_2l_write_register(ViPipe, 0x3446, 0x57); /* global timing */
    imx327_2l_write_register(ViPipe, 0x3447, 0x00);
    imx327_2l_write_register(ViPipe, 0x3448, 0x37);
    imx327_2l_write_register(ViPipe, 0x3449, 0x00);
    imx327_2l_write_register(ViPipe, 0x344a, 0x1F);
