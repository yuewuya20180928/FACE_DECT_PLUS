...
void gc2145_linear_UXGA_init(VI_PIPE ViPipe);
...
void gc2145_init(VI_PIPE ViPipe)
{
    ...
    switch (u8ImgMode)
    {
        case GC2145_SENSOR_UXGA_30FPS_LINEAR_MODE:
            gc2145_linear_UXGA_init(ViPipe);
            break;
    ...
    printf("Func:%s, Line:%d, u8ImgMode = %d\n", __FUNCTION__, __LINE__, u8ImgMode);
...
void gc2145_linear_UXGA_init(VI_PIPE ViPipe)
{
    ...
    gc2145_write_register(ViPipe, 0x12, 0xd0);
    gc2145_write_register(ViPipe, 0x13, 0x07);
